...
SECRET_KEY = 'django-insecure-_8)x1!d^l(tbly^a2x!11fdqmh4hlt@vv+*zrkvk0f-h$5mr)f'
...
INSTALLED_APPS = [
    ...
    'corsheaders',  # To allow React frontend to access backend
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",  # Allow frontend to connect
]
